import scrapy
from ..items import InternshipItem

class IntershipSpider(scrapy.Spider):

    crawled_set = {'https://www.forbesindia.com/celebprofile2019/virat-kohli/1819/1'}
    ...
    def parse(self, response):
        ...
        earnings_2019_In_Rs_crore = [response.css('tr:nth-child(5) td+ td::text')[0].extract().strip()]
        ...
        items['earnings_2019_In_Rs_crore'] = earnings_2019_In_Rs_crore
        ...
        if next_page not in IntershipSpider.crawled_set:
            IntershipSpider.crawled_set.add(next_page)
